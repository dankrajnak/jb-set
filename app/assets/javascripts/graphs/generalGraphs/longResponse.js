(function (global) {
	...
	var module = generalGraph.longResponse = {};
	...
	module.draw = function (grph, questn) {
		...
		if (!isDrawn) {
			...
			graphBase.append('button').attr('class', 'long-response-prev').attr('onClick', 'window.graph.graphs.generalGraph.longResponse.showPrevious()').html('< Prev');
			graphBase.append('button').attr('class', 'long-response-next').attr('onClick', 'window.graph.graphs.generalGraph.longResponse.showNext()').html('Next >');
